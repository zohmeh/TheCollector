...
class AuctionDetailDesktopView extends StatefulWidget {
  final TextEditingController bidamountController = TextEditingController();
  final id;
  AuctionDetailDesktopView({this.id});

  @override
  _AuctionDetailDesktopViewState createState() =>
      _AuctionDetailDesktopViewState();
}

class _AuctionDetailDesktopViewState extends State<AuctionDetailDesktopView> {
  var highestBid;
  var highestBidder;
